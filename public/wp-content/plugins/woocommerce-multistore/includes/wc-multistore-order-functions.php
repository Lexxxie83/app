...
if( ! function_exists( 'wc_multistore_get_orders' ) ) {
	...
	function wc_multistore_get_orders( $per_page, $paged, $post_status, $search ) {
		...
		$queried_orders_total_args = apply_filters( 'wc_multistore_network_orders_total_args', $queried_orders_total_args );
...
if (!function_exists('wc_multistore_is_hpos_enabled')){

	function wc_multistore_is_hpos_enabled() {
		$is_enabled = false;

		if(class_exists('Automattic\WooCommerce\Utilities\OrderUtil')){
			$is_enabled = Automattic\WooCommerce\Utilities\OrderUtil::custom_orders_table_usage_is_enabled();
		}
