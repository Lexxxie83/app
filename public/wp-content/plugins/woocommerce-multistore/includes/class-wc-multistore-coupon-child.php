	...
	public function create($data){
		...
		if ( ! empty( $props['product_ids'] ) ) {
			...
			foreach ( $props['product_ids'] as $key => $parent_id ){
				if( $product_id = wc_multistore_product_get_slave_product_id( $parent_id, $props['product_skus'][$key], $props['wpml_included_products'][$key] ) ){
		...
		if ( ! empty( $props['excluded_product_ids'] ) ) {
			...
			foreach ( $props['excluded_product_ids'] as $key => $parent_id ){
				if( $excluded_product_id = wc_multistore_product_get_slave_product_id( $parent_id, $props['excluded_product_skus'][$key], $props['wpml_excluded_products'][$key] ) ){
