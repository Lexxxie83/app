...
//	);
	...
	public function __construct(){
		...
		$this->create_global_images_tables();
		$this->create_attributes_relationships_tables();
	}

	public function create_global_images_tables(){
	...
	public function create_attributes_relationships_tables(){
		...
		$table_name  = $wpdb->prefix . 'woo_multistore_attributes_relationships';
		$collate     = $wpdb->has_cap( 'collation' ) ? $wpdb->get_charset_collate() : '';
		...
		$exists      = $this->maybe_create_table(
			...
			"
			CREATE TABLE {$table_name} (
				attribute_id bigint(20) unsigned NOT NULL UNIQUE,
				child_attribute_id bigint(20) unsigned NOT NULL UNIQUE,
