...
class WC_Multistore_Order_Hooks_Master {
	...
	public function hooks(){
		...
		add_action( 'wc_multistore_send_imported_order', array( $this, 'wc_multistore_send_imported_order'));
	...
	public function wc_multistore_send_imported_order( $order_id ){
	...
	public function on_update_imported_order( $order_id, $wc_order ){
		...
		$scheduled_actions = as_get_scheduled_actions(
			array(
				'hook'   => 'wc_multistore_send_imported_order',
		...
		as_enqueue_async_action('wc_multistore_send_imported_order', array( 'order_id' => $order_id ),'wc_multistore' );

		$this->disable_emails();

		do_action('wc_multistore_after_import_order_hook_master', $wc_order, $order_id);
