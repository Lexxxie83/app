...
class WC_Multistore_Custom_Taxonomy {
	...
	public function add_submenu_multisite() {
		...
		add_action( 'load-' . $hook_id, array( $this, 'admin_print_scripts' ) );
	}
	...
	public function admin_print_scripts() {
		wp_register_script('wc-multistore-custom-settings-js',WOO_MSTORE_URL . '/assets/js/wc-multistore-custom-settings.js', array('jquery' ),WOO_MSTORE_VERSION,true );
		wp_localize_script(	'wc-multistore-custom-settings-js','wc_multistore_ajax',array('ajax_url' => admin_url( 'admin-ajax.php' ) ) );
		wp_enqueue_script('wc-multistore-custom-settings-js' );
	}
