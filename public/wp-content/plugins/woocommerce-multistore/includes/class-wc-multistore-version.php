...
class WC_Multistore_Version {
	...
	public function check_versions() {
		...
		set_transient( 'wc_multistore_version_check', time(), 6 * 60 * 60 );
		...
		if ( $_set_update_notice === true ) {
			set_transient( 'wc_multistore_show_update_notice', true, 6 * 60 * 60 );
		} else {
	...
	public function show_update_notice() {
        ...
        <div class="notice notice-error is-dismissible">
            <p><?php _e( 'Version 5.3.7 of <a target="_blank" href="https://woomultistore.com/"> WooMultistore</a> requires at least version 5.3.7 running on all child stores in order to avoid conflicts.' ); ?></p>
            <p><?php _e( 'You may update from WordPress or download the plugin from the <a target="_blank" href="https://woomultistore.com/my-account/downloads/"> download section </a> of our website. If you have updated recently, you can ignore the warning.' ); ?></p>
        </div>
		<?php
	}
}
