			...
			<tbody>
				...
				<tr valign="top">
					...
					<td>
						<p>
							<label>
								<input type="text" value="<?php echo empty( $export_time_after ) ? '' : date( 'm/d/Y', wc_string_to_timestamp($export_time_after) ); ?>" id="export_time_after" name="export_time_after" />
						...
						<p>
							<label>
								<input type="text" value="<?php echo empty( $export_time_before ) || 9999999999 == $export_time_before ? '' : date( 'm/d/Y', wc_string_to_timestamp($export_time_before) ); ?>" id="export_time_before" name="export_time_before" />
								<span class="dashicons dashicons-calendar-alt"></span>
