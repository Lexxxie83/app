...
final class WOO_MSTORE_MULTI_INIT {
	...
	public function define_constants() {
		...
		$this->define( 'WOO_MSTORE_APP_API_URL', 'https://woomultistore.com' );
		...
		$this->define( 'WOO_MSTORE_VERSION', '5.3.9' );
	...
	public function includes(){
		...
		require_once WOO_MSTORE_PATH . '/includes/admin/meta-boxes/class-wc-multistore-meta-box-order-data.php';
		...
		require_once WOO_MSTORE_PATH . '/includes/ajax/class-wc-multistore-ajax-settings-master.php';
		...
		require_once WOO_MSTORE_PATH . '/includes/hooks/class-wc-multistore-attribute-hooks-child.php';
...
//		require_once WOO_MSTORE_PATH . '/includes/class-wc-multistore-compatibility.php';
	...
	public function init(){
		...
		$GLOBALS['WC_Multistore_Ajax_Settings_Master'] = new WC_Multistore_Ajax_Settings_Master();
		...
		$GLOBALS['WC_Multistore_Meta_Box_Order_Data'] = new WC_Multistore_Meta_Box_Order_Data();
		...
		$GLOBALS['WC_Multistore_Attribute_Hooks_Child'] = new WC_Multistore_Attribute_Hooks_Child();
...
//		$GLOBALS['WC_Multistore_Compatibility'] = new WC_Multistore_Compatibility();
	...
	public function action_links( $links, $file ) {
		$settings_url = network_admin_url( 'admin.php?page=wc-multistore-settings' );
		if( ! is_multisite() && WOO_MULTISTORE()->site->get_type() != 'master' ){
			$master_data = get_site_option('wc_multistore_master_connect');
			if( ! empty( $master_data ) ){
				$settings_url = $master_data['master_url'] . '/wp-admin/admin.php?page=wc-multistore-settings';
			}
		}
